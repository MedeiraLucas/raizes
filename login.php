<!-- 
    AVISO:
    DESENVOLVIMENTO POR RAIZES DESENVOLVIMENTO
-->
...
<body>
  <section class="row mx-0 min-vh-100">
    ...
    <div class="colunaLogin col-md-6 col-lg-4 d-flex align-items-center px-md-4 px-lg-4">
      <div class="w-100">
        ...
        <form id="formLogin" action="login.php" method="post">
          ...
          <div class="d-flex justify-content-between mb-3 small">
            ...
            <a href="" class="text-decoration-none txtEsqueceSenha">Registrar</a>
          </div>
      ...
      <div class="versaoSistema"><p><b>Raizes desenvolvimento</b><br>Copyright © 2024</p></div>
    </div>
  </section>
</body>
</html>